...
function renderViewModalidad(container) {
    renderViewTipoClaseGenerico(container, {
        ...
        endpointGet  : "http://127.0.0.1:5000/modalidades",
        endpointPost : "http://127.0.0.1:5000/modalidades",
        endpointEstado: id => `http://127.0.0.1:5000/modalidades/${id}/estado`,
...
function renderViewTipoPrograma(container) {
    renderViewTipoClaseGenerico(container, {
        ...
        endpointGet  : "http://127.0.0.1:5000/tipos-programa",
        endpointPost : "http://127.0.0.1:5000/tipos-programa",
        endpointEstado: id => `http://127.0.0.1:5000/tipos-programa/${id}/estado`,
        keyLista     : "tipos",
        keyItem      : "tipo",
